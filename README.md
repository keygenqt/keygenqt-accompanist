...
### ![picture](https://github.com/google/material-design-icons/blob/master/png/search/manage_search/materialicons/24dp/1x/baseline_manage_search_black_18dp.png?raw=true) [MainScaffoldSearch](./docs/MainScaffoldSearch.md)
The main block of the application with topBar which has a built-in search and loader

### ![picture](https://github.com/google/material-design-icons/blob/master/png/action/view_list/materialicons/24dp/1x/baseline_view_list_black_18dp.png?raw=true) [SwipeRefreshList](./docs/SwipeRefreshList.md)
